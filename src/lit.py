...
"""
    Handle literature through arxive API
"""
...
class Paper:
    """
    Class to handle a single publication
    """
...
def is_within_last_week(given_date):
    ...
    return (
        last_week.astimezone(None)
        <= given_date.astimezone(None)
        <= current_date.astimezone(None)
    )
